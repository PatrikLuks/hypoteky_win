...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("DB_NAME", "hypoteky"),
...
if not FIELD_ENCRYPTION_KEY:
    raise ValueError(
        "ENCRYPTED_MODEL_FIELDS_KEY není nastavena v .env souboru. "
        'Vygeneruj nový klíč: python -c "from cryptography.fernet import Fernet; print(Fernet.generate_key().decode())" '
