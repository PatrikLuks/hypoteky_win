...
class NotifikaceZamitnutiTestCase(TestCase):
    def setUp(self):
        ...
        self.poradce = User.objects.create_user(username='poradce2', email='poradce2@example.com', password='testpass')
    ...
    def test_zamitnuti_notifikace_vygeneruje_email_a_log(self):
        ...
        log = NotifikaceLog.objects.filter(prijemce=self.poradce.email, klient=self.klient, typ='zamítnutí')
