...
class ImportKlientuXLSXTestCase(TestCase):
    ...
    def test_import_xlsx_extremni_znaky_a_hodnoty(self):
        ...
        self.assertIn(
            dlouhe_jmeno[:100],
            jmena,
            "Klient s dlouhým jménem nebyl správně zkrácen a importován.",
        )
        ...
        self.assertIn(
            "Petr Velký", jmena, "Klient s extrémní částkou nebyl importován."
        )
        self.assertIn(
            "Marek Nula",
            jmena,
            "Klient s nulovou nebo zápornou částkou nebyl importován.",
        )
        self.assertIn(
            "Eva SQL", jmena, "Klient s pokusem o SQL injection nebyl importován."
        )
